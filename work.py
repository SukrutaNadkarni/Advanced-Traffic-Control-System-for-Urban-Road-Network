...
# Function to count the number of vehicles approaching the signal
def countVehicles():
    counts = [0, 0, 0, 0]
...
def repeat():
    ...
    while(True):
        counts = countVehicles()
        signals[currentGreen].green = max(10, min(30, counts[currentGreen] * 2))  # Dynamic green time based on vehicle count
